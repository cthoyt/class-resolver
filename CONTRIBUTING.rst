...
----------------------------------
1. Check that you have the latest version of :code:`class_resolver`
2. Check that StackOverflow hasn't already solved your problem
3. Go here: https://github.com/cthoyt/class-resolver/issues
...
1. Get the code. Fork the repository from GitHub using the big green button in the top-right corner of
   https://github.com/cthoyt/class-resolver
2. Clone your directory with

.. code-block:: sh

    $ git clone https://github.com/<YourUsername>/class-resolver
...
If you spend a while working on your changes, further commits may be made to the main :code:`class_resolver`
...
.. code-block:: sh
    ...
    $ git remote add upstream https://github.com/cthoyt/class-resolver
